...
class EmotionController {
    ...
    @PostMapping("/emotion")
    fun addEmotion(request: HttpServletRequest,@RequestBody emotionDto: EmotionDto): ResponseEntity<UUID> {
    ...
    fun addEmotionsName(@RequestBody emotionNameDto: EmotionNameDto): ResponseEntity<UUID> {
